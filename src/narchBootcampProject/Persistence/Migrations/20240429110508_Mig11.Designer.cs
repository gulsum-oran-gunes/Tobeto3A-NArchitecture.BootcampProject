...
namespace Persistence.Migrations
{
    ...
    [Migration("20240429110508_Mig11")]
    partial class Mig11
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("46b2361f-e029-4989-bbed-66afe042c778"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(2024, 4, 29, 14, 5, 7, 731, DateTimeKind.Local).AddTicks(5857),
                            Email = "admin@mail",
                            FirstName = "Admin",
                            LastName = "Oran",
                            NationalIdentity = "123456",
                            PasswordHash = new byte[] { 248, 90, 255, 37, 129, 57, 88, 255, 153, 84, 34, 113, 131, 14, 121, 90, 96, 224, 207, 134, 97, 163, 198, 76, 76, 198, 90, 11, 48, 129, 58, 162, 84, 55, 90, 64, 22, 71, 94, 183, 175, 36, 243, 155, 83, 221, 34, 108, 19, 29, 227, 139, 112, 162, 139, 88, 98, 27, 133, 121, 225, 105, 78, 108 },
                            PasswordSalt = new byte[] { 114, 101, 125, 18, 209, 230, 221, 217, 82, 85, 40, 241, 50, 56, 30, 138, 152, 176, 233, 60, 117, 68, 35, 208, 29, 181, 143, 43, 140, 143, 235, 169, 84, 247, 1, 176, 175, 229, 139, 37, 103, 217, 5, 133, 96, 102, 17, 112, 153, 33, 147, 170, 226, 98, 22, 28, 73, 39, 205, 244, 138, 40, 90, 126, 157, 193, 224, 234, 80, 5, 178, 95, 140, 35, 153, 66, 232, 253, 43, 157, 178, 134, 164, 235, 45, 107, 200, 179, 4, 206, 58, 24, 81, 144, 62, 243, 132, 186, 85, 217, 127, 26, 189, 68, 160, 19, 108, 14, 201, 220, 163, 94, 20, 49, 28, 200, 185, 120, 68, 23, 140, 157, 39, 192, 86, 221, 125, 29 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9ce224b6-fa66-4971-a1d6-84d71428a914"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("46b2361f-e029-4989-bbed-66afe042c778")
                        });
                });
