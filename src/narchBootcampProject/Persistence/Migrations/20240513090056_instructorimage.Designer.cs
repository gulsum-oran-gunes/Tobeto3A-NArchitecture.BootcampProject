...
namespace Persistence.Migrations
{
    ...
    [Migration("20240513090056_instructorimage")]
    partial class instructorimage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6f705d37-a89e-40c3-a2c2-e7a949de7d75"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(2024, 5, 13, 12, 0, 55, 378, DateTimeKind.Local).AddTicks(2965),
                            Email = "admin@mail",
                            FirstName = "Admin",
                            LastName = "Oran",
                            NationalIdentity = "123456",
                            PasswordHash = new byte[] { 9, 117, 54, 99, 138, 17, 215, 80, 199, 105, 246, 6, 74, 133, 196, 58, 140, 45, 68, 88, 17, 21, 6, 67, 85, 1, 159, 1, 7, 6, 110, 65, 246, 29, 128, 250, 38, 37, 115, 119, 227, 72, 203, 255, 122, 53, 101, 117, 221, 20, 239, 38, 255, 36, 176, 195, 18, 63, 209, 130, 241, 195, 89, 184 },
                            PasswordSalt = new byte[] { 22, 118, 13, 212, 126, 72, 82, 227, 192, 131, 217, 109, 135, 232, 18, 62, 133, 157, 164, 162, 24, 139, 110, 119, 50, 81, 46, 200, 200, 10, 215, 137, 153, 188, 8, 90, 26, 140, 121, 209, 180, 52, 240, 141, 174, 61, 37, 34, 115, 120, 214, 224, 232, 178, 129, 192, 113, 238, 236, 73, 99, 241, 36, 181, 99, 84, 76, 92, 78, 255, 133, 138, 61, 157, 45, 53, 47, 118, 52, 103, 238, 233, 51, 165, 151, 1, 162, 234, 244, 66, 64, 54, 251, 241, 183, 44, 80, 225, 90, 114, 253, 88, 95, 80, 65, 196, 59, 13, 68, 155, 99, 29, 164, 62, 25, 167, 137, 196, 198, 63, 143, 172, 168, 89, 213, 165, 210, 40 },
                            UserName = "admin"
                        },
                        new
                        {
                            Id = new Guid("d248f0eb-a1da-45bb-9a5c-ab46f1d5dc83"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            LastName = "Oran",
                            NationalIdentity = "123456",
                            PasswordHash = new byte[] { 124, 101, 104, 206, 49, 184, 76, 16, 82, 198, 90, 87, 163, 57, 68, 70, 155, 248, 95, 240, 107, 91, 243, 166, 77, 254, 244, 1, 161, 118, 213, 208, 45, 112, 169, 121, 45, 246, 30, 97, 247, 245, 169, 120, 236, 196, 249, 111, 86, 107, 95, 105, 221, 38, 30, 186, 27, 179, 35, 63, 112, 205, 164, 12 },
                            PasswordSalt = new byte[] { 30, 90, 56, 78, 190, 14, 218, 88, 59, 244, 214, 66, 214, 189, 53, 10, 202, 111, 33, 130, 58, 213, 197, 80, 227, 53, 67, 58, 27, 149, 72, 123, 202, 93, 125, 254, 107, 133, 244, 48, 175, 13, 196, 86, 200, 110, 73, 50, 35, 107, 9, 218, 132, 238, 235, 28, 168, 20, 7, 159, 88, 247, 52, 66, 108, 117, 94, 197, 89, 241, 222, 148, 33, 27, 88, 28, 218, 99, 230, 7, 67, 56, 173, 164, 44, 63, 30, 43, 192, 225, 50, 26, 71, 132, 233, 94, 180, 114, 187, 197, 237, 237, 55, 237, 231, 48, 71, 108, 140, 14, 161, 20, 72, 190, 90, 213, 133, 22, 97, 146, 74, 86, 111, 107, 83, 155, 79, 208 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aab8b06f-079c-4afc-8f31-58d3f1523563"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("6f705d37-a89e-40c3-a2c2-e7a949de7d75")
                        });
                });
