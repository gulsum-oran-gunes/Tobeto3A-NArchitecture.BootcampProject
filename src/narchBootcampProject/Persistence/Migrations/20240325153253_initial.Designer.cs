...
namespace Persistence.Migrations
{
    ...
    [Migration("20240325153253_initial")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("231d4959-10b8-4d18-9fc3-bac9e91d268c"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(2024, 3, 25, 18, 32, 53, 214, DateTimeKind.Local).AddTicks(981),
                            Email = "gulsum.oran@hotmail.com",
                            FirstName = "Gulsum",
                            LastName = "Oran",
                            NationalIdentity = "123456",
                            PasswordHash = new byte[] { 250, 95, 125, 186, 205, 164, 103, 72, 236, 56, 157, 51, 173, 100, 55, 94, 70, 172, 245, 138, 191, 31, 149, 188, 15, 131, 125, 100, 145, 235, 92, 211, 64, 160, 127, 77, 38, 173, 156, 241, 102, 143, 238, 133, 119, 157, 109, 91, 129, 141, 84, 106, 32, 132, 169, 88, 176, 218, 97, 204, 115, 245, 123, 107 },
                            PasswordSalt = new byte[] { 209, 98, 169, 31, 114, 141, 172, 145, 253, 225, 32, 125, 109, 108, 143, 66, 186, 175, 15, 207, 3, 226, 132, 124, 151, 175, 52, 209, 136, 130, 126, 64, 247, 178, 46, 148, 15, 177, 121, 246, 73, 126, 223, 82, 149, 37, 135, 33, 194, 248, 98, 86, 165, 143, 13, 144, 17, 79, 192, 46, 163, 60, 88, 225, 244, 106, 144, 66, 188, 226, 186, 191, 164, 98, 152, 212, 122, 207, 50, 9, 105, 19, 252, 225, 171, 200, 188, 142, 96, 105, 127, 167, 27, 187, 135, 128, 55, 36, 118, 71, 215, 38, 30, 170, 229, 142, 53, 103, 252, 13, 98, 167, 147, 57, 196, 173, 11, 240, 59, 150, 147, 98, 232, 192, 106, 251, 109, 5 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d6c903ba-7fc3-44b3-9839-5d2c72f97929"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("231d4959-10b8-4d18-9fc3-bac9e91d268c")
                        });
                });
