...
#pragma warning disable S1854 // Unused assignments should be removed
    private IEnumerable<OperationClaim> getFeatureOperationClaims(int initialId)
    {
        ...
        #region ApplicationEntities
        featureOperationClaims.AddRange(
            [
                new() { Id = ++lastId, Name = ApplicationEntitiesOperationClaims.Admin },
                new() { Id = ++lastId, Name = ApplicationEntitiesOperationClaims.Read },
                new() { Id = ++lastId, Name = ApplicationEntitiesOperationClaims.Write },
                new() { Id = ++lastId, Name = ApplicationEntitiesOperationClaims.Create },
                new() { Id = ++lastId, Name = ApplicationEntitiesOperationClaims.Update },
                new() { Id = ++lastId, Name = ApplicationEntitiesOperationClaims.Delete },
            ]
        );
        #endregion
